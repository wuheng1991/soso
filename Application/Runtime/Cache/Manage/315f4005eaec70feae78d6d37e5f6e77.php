...
<div id="toper">
	<div class="top">
    	<ul class="top_l">
			<li><a href="<?php echo U('Primer/index');?>">返回列表</a></li>
...
<div id="main">
    ...
    <?php if(!empty($list)): ?><table   width="100%" border="1"   style="text-align:center;border-collapse:collapse;">
        ...
        <?php if(is_array($list)): foreach($list as $key=>$L): ?><tr align="center">
          ...
          <!--   <td><input type="checkbox" <?php if($L["isreserve"] == 2): ?>checked<?php endif; ?>/></td> -->

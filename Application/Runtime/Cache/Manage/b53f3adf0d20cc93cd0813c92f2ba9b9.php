           ...
           <!--  <br>
            ...
            <!-- <hr> -->
             <!-- <table width="100%" style="border-collapse:collapse;" cellpadding="4" cellspacing="0" border="1" class="bj-1">
                <legend><h3><span style="color:green;">分子生物学服务项目跟踪基本信息</span></h3></legend>
                <tr>
                    <td width="70"  rowspan="2" align="center" class="index-7">地&nbsp;&nbsp;&nbsp;区<br></td>
                    <td width="70"   rowspan="2" align="center" class="index-7">销售员</td>
                    <td width="90"  rowspan="2"  align="center" class="index-7">合同编号</td>
                    <td width="200"  rowspan="2"  align="center" class="index-7">项目名称<br></td>
                    <td width="100"   colspan="2" align="center" class="index-7">客户信息</td>
                    <td width="160"  rowspan="2"  align="center" class="index-7">项目细分</td>
                    <td width="87"  rowspan="2" align="center" class="index-7">预计项目周期</td>
                    <td width="80"  rowspan="2" align="center" class="index-7">合同期限</td>
                    <td width="87"  rowspan="2" align="center" class="index-7">项目状态</td>
                    <td width="87"  rowspan="2" align="center" class="index-7">最新更新时间</td>
                ...
                <tr>
                    ...
                    <?php echo ($fen_info['fen_name']); ?>
                    </td>
                    <td  align="center" class="bj-3"> 
                    <?php echo ($fen_info['fen_sale']); ?>
                    </td>
                    <td  align="center" class="bj-3">
                       <?php echo ($fen_info['fen_he']); ?>
                    </td>
                    <td  align="left" class="bj-3">
                      <?php echo ($fen_info['fen_pro']); ?>
                    </td>
                    <td  align="left" class="bj-3">
                       <?php echo ($fen_info['fen_customer']); ?>
                    </td>
                    <td  align="center" class="bj-3"> 
                       <?php echo ($fen_info['fen_contact']); ?>                     
                    </td>
                    <td  align="left" style="padding:0px;" class="bj-3"> 
                      <?php echo ($fen_info['fen_xi']); ?> 
                    </td>
                    <td  align="center" class="bj-3">
                       <?php echo ($fen_info['fen_date']); ?> 
                    </td>
                    <td  align="center" class="bj-3">
                        <?php echo ($fen_info['fen_date_xian']); ?>
                        
                    </td>
                    <td  align="center" class="bj-3"><span style="color:green;">
                         <?php echo (pro_status($fen_info['fen_status'])); ?> 
                    </span></td>
                    <td  align="center" class="bj-3">
                        <?php echo (date("Y-m-d",$fen_info['addtime'])); ?> 
                    </td>                   
                </tr>
               ...
               <table class="fen_list" width="100%" cellpadding="4" cellspacing="0" border="0" align="center">
                <legend><h3><center><span style="color:green;">
                    ...
                    <tr>
                        ...
                        <input type="radio"  id="fen_position_s" value="1" name="fen_position" disabled 
                        <?php if(($fen_info['fen_position']) == "1"): ?>checked<?php endif; ?>/>南
                            <input type="radio"  id="fen_position_n" value="2" name="fen_position" disabled
                    ...
                    <tr>
                        ...
                        <label for="">销售员：</label>
                        <input type="text"  style="border-left:0px;border-right:0px;border-top:0px;" id="fen_sale" size="38" name="fen_sale" value="<?php echo ($fen_info["fen_sale"]); ?>" readonly/>
                        </td>
            ...
            <tr>
                    <td>
                        ...
                        <td>
                         ...
                         <input type="text"  style="border-left:0px;border-right:0px;border-top:0px;" id="fen_contact" size="38" name="fen_contact" value="<?php echo ($fen_info["fen_contact"]); ?>" readonly/>
                        </td>
            ...
            <tr>
                <td align="left"> 
                        ...
                        <input type="text"  style="border-left:0px;border-right:0px;border-top:0px;" id="fen_Email" size="45" name="fen_Email" value="<?php echo ($fen_info["fen_email"]); ?>" readonly/>
                    </td>
                        <td align="left"> 
                        <label for="fen_pi">实验室负责人：</label>    
                                   
                        <input type="text"  style="border-left:0px;border-right:0px;border-top:0px;" id="fen_pi" size="33" name="fen_pi" value="<?php echo ($fen_info["fen_pi"]); ?>" readonly/>
                    </td>
            ...
            <tr>
                <td align="left"> 
                     ...
                     <td > 
                        ...
                        id="fen_he_money" size="32" name="fen_he_money" value="<?php echo ($fen_info["fen_he_money"]); ?>" placeholder="只填数字即可" disabled/>
                    </td>
             ...
             <tr>
                <td align="left">
                     <label for="fen_money">预付款情况：</label>
                       <input type="text"   style="border-left:0px;border-right:0px;border-top:0px;" 
                        id="fen_money" size="44" name="fen_money" value="<?php echo ($fen_info["fen_money"]); ?>" placeholder="" disabled/> 
                </td>
            </tr>

...
<form id="sequencingForm" method="post" autocomplete="off" action="<?php echo U('Pro/fen_more',array('type'=>$fen_type,'p'=>$curr_page));?>">
		...
		<td width="100%" align="center" valign="top" bgcolor="#FFFFFF">
        	<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<td>
						<table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" style="border-bottom:#ccc solid 1px; margin-bottom:10px;">
							<tr>
								...
								<td width="25%"><a href="/index.php/Manage.html" target="top">后台主页</a>&nbsp;&nbsp;&nbsp;&nbsp;
									武汉金开瑞生物工程有限公司
								</td>
							</tr>
						</table>
               ...
               <table width="100%" style="border-collapse:collapse;" cellspacing="0" border="0" align="center">
					 <tr>
					 	  ...
					 	  <td>
					 	  	<input type="radio" name="fen_position" value="1" <?php if(($fen_position) == "1"): ?>checked<?php endif; ?>/>南
					 	  	<input type="radio" name="fen_position" value="2" <?php if(($fen_position) == "2"): ?>checked<?php endif; ?> />北
					 	  </td>
						   ...
						   销售员：<input type="text" name="fen_sale" size="20" value="<?php echo ($fen_sale); ?>" />
					        ...
					        <td  >
						   合同编号：<input type="text" name="fen_he" size="20" value="<?php echo ($fen_he); ?>" />
					       </td>
					...
					<tr>
						<td colspan=5>
							<span style="color:red;">通知：已经将项目为：<span style="color:green;">"项目结束状态"</span>的项目隐藏。如果要查看已完成的项目,可以选择<span style="color:green;">"项目状态"</span>下的<span style="color:green;">"项目结束状态"</span>,然后点击"查询"即可。</span>
						</td>
					</tr>
			   </table>
					</td>
			...
			<!-- 	<legend style="text-align:right;"><h4>
				...
				<?php if(is_array($fen_info)): foreach($fen_info as $key=>$fen_row): ?><tr>
					...
					<td align="center" class="bj-3">
						 &nbsp;
						<a href="<?php echo U('Pro/fen_index',array('id'=>$fen_row['id']));?>">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
					 	<a href="<?php echo U('Pro/fen_editor',array('id'=>$fen_row['id'],'type'=>$fen_type));?>">编辑</a>
					 	<!-- &nbsp;&nbsp;|&nbsp;&nbsp; -->
						 <br/>
                    	...
                    	<table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" bgcolor="#F9F9F9" class="index-3">
							<tr>
								...
								<td width="410" align="left" class="bj-3">
									<!-- <button class="wuhan" style="cursor:pointer;">   返回上一步  </button> -->
									 
								</td>
								<td width="250" align="center" class="bj-3">
									共<?php echo ($countNum); ?>条记录;&nbsp;&nbsp;
									共<?php echo ($pages); ?>页;&nbsp;&nbsp;当前第<?php echo ($page); ?>页&nbsp;&nbsp;<img id="pre" title="上一页" src="/Public/Consel/images/2_r2.jpg" width="15" height="15">&nbsp;&nbsp;
								...
								<select id="select7" name="select7" class="index-12">
                                  ...
                                  <?php $__FOR_START_2074527681__=1;$__FOR_END_2074527681__=$pages+1;for($pageNum=$__FOR_START_2074527681__;$pageNum < $__FOR_END_2074527681__;$pageNum+=1){ ?><option value="<?php echo ($pageNum); ?>"><?php echo ($pageNum); ?></option><?php } ?>
                                </select>
								页</td>
							</tr>
						</table>

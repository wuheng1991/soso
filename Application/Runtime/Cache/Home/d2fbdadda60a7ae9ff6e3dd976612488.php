...
<div id="main">
	<div class="maincon">
		...
		<table width="50%" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr>
                <td width="90" align="left">金开瑞编号：</td>
                <td width="330" style="border-bottom:#000 1px dotted">
                    <span id="lblOrderID"><?php echo ($orderInfo["gs_num"]); ?></span>
                </td>
            </tr>

             <tr>
                <td width="90" align="left">合同编号：</td>
                <td width="330" style="border-bottom:#000 1px dotted">
                    <span id="lblOrderID"><?php echo ($orderInfo["gs_he"]); ?></span>
                </td>
            </tr>
            ...
            <tr>
                <td align="left">订单数目：</td>
                <td style="border-bottom:#000 1px dotted"><span id="lblOrderSmaplsCount">
                   ...
                   <?php elseif($orderInfo["synthesis"] == 7): ?>
                      ...
                      <!--   <td  >
                         ...
                         <td colspan="2" >
                            ...
                            <?php else: ?>
                           <a href="<?php echo U('Gene/xiazai','id='.$orderid);?>" title="点击下载">文件(夹)下载</a><?php endif; ?>
    ...
    <span style="color:red;font-family:微软雅黑;">系统消息：尊敬的客户，您好！ 有什么服务需要咨询吗？
       ...
       <!--  <textarea> -->
        ...
        <!-- end -->
    <div class="order_con" style="margin-top:80px;">
   <div class="bread" style="margin:16px 0 10px -10px;">基因订单信息</div>
    <!--基因信息开始-->
      <?php if(is_array($genelist)): foreach($genelist as $k=>$wh): ?><table border="1" style="border-collapse:collapse;padding:2px;line-height:10px;">
              <tr align="center" class="wuheng" bgcolor="#276CC7" style="background:red;">
                 <td style="background:#276CC7;color:white;">基因合成服务-<?php echo ($k+1); ?></td>
                 <td style="background:#276CC7;color:white;">
                    <!--  <a href="<?php echo U("Gene/editors");?>?id=<?php echo ($wh["id"]); ?>" style="color:white;padding:3px;">编辑</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                      <a href="<?php echo U("Gene/copy_gene_order");?>?id=<?php echo ($wh["id"]); ?>"  style="color:white;padding:3px;">复制</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                       <a href="<?php echo U("Gene/del_gene_order");?>?id=<?php echo ($wh["id"]); ?>"  style="color:white;padding:3px;">删除</a> -->
                 </td>
             </tr>
             <tr align="center">
                 ...
                 <td align="left">
                            ...
                            基因名称：<?php echo ($wh["gene_name"]); ?><br/>
                             碱基/氨基酸数量：<?php echo ($wh["gene_contents_num"]); ?><br/>
                        <?php if(($wh['gene_serial_sel']) == "1"): ?>DNA序列：
                         <?php else: ?>
                            蛋白质序列：<?php endif; ?>   
                         <br/> 
                             <!-- <?php echo ($wh["gene_contents"]); ?> -->
                           <?php  $content = $wh['gene_contents']; $content = str_replace(" ","",$content); $content = str_replace("\n","",$content); $content = str_replace("\r","",$content); $length = strlen($content); $num = ceil($length/10); $rows = ($length / 50) + 1; $arr=array(); $flag = 0; $sub = ""; echo "<textarea  rows='".$rows."' readonly=\"readonly\" cols='80'>"; for($ii = 0;$ii < $num ; $ii ++){ $sub = substr($content,$ii * 10,10); echo $sub."  "; $flag ++; if($flag % 5 == 0){ echo "\n"; } $sub = ""; } echo "</textarea>"; ?>  

                             <br/>
                             5'序列：<?php echo ($wh["gene_serial_5"]); ?><br/>
                             3'序列：<?php echo ($wh["gene_serial_3"]); ?><br/>
                           
                         
                     
                 </td>
             </tr>
                 <?php if(($wh["gene_seo"]) == "1"): ?><tr align="center">
                         <td style="color:black;">密码子优化</td>
                         <td align="left">
                             表达宿主:
                               <?php if(($wh['gene_seo_host']) == "0"): endif; ?>
<?php if(($wh['gene_seo_host']) == "1"): ?>Arabidopsis thaliana<?php endif; ?>
<?php if(($wh['gene_seo_host']) == "2"): ?>Bacillus subtilis<?php endif; ?> 
<?php if(($wh['gene_seo_host']) == "3"): ?>Bos taurus<?php endif; ?> 
<?php if(($wh['gene_seo_host']) == "4"): ?>Brassica napus<?php endif; ?> 
<?php if(($wh['gene_seo_host']) == "5"): ?>Caenorhabditis elegans<?php endif; ?> 
<?php if(($wh['gene_seo_host']) == "6"): ?>Chlamydomonas reinhardtii<?php endif; ?> 
<?php if(($wh['gene_seo_host']) == "7"): ?>Cricetulus griseus<?php endif; ?> 
<?php if(($wh['gene_seo_host']) == "8"): ?>Drosophila melanogaster<?php endif; ?> 
<?php if(($wh['gene_seo_host']) == "9"): ?>Escherichia coli<?php endif; ?> 
<?php if(($wh['gene_seo_host']) == "10"): ?>Homo sapiens<?php endif; ?>
<?php if(($wh['gene_seo_host']) == "11"): ?>Mus musculus<?php endif; ?> 
<?php if(($wh['gene_seo_host']) == "12"): ?>Nicotiana tabacum<?php endif; ?> 
<?php if(($wh['gene_seo_host']) == "13"): ?>Oryza sativa<?php endif; ?>
<?php if(($wh['gene_seo_host']) == "14"): ?>Pichia pastoris<?php endif; ?> 
<?php if(($wh['gene_seo_host']) == "15"): ?>Saccharomyces cerevisiae<?php endif; ?> 
<?php if(($wh['gene_seo_host']) == "16"): ?>Zea mays<?php endif; ?> 
<?php if(($wh['gene_seo_host']) == "17"): ?>Other<?php endif; ?> 
                              &nbsp;;&nbsp;
                              其他 ： <?php echo ($wh["gene_seo_host_aa"]); ?>  &nbsp;;&nbsp;
                             <!-- ;优化的起始位点:<?php echo ($wh['gene_seo_start']); ?>
                             <?php if(($wh['gene_start']) == "1"): ?>bp<?php endif; ?>
                              <?php if(($wh['gene_start']) == "2"): ?>aa<?php endif; ?>
                              
                             ;结束位点:<?php echo ($wh['gene_seo_end']); ?>
                              <?php if(($wh['gene_end']) == "1"): ?>bp<?php endif; ?>
                              <?php if(($wh['gene_end']) == "2"): ?>aa<?php endif; ?>
                              
                             ;ORF 开始位点:<?php echo ($wh['gene_orf_start']); ?>;
                             结束位点:<?php echo ($wh['gene_orf_end']); ?>; -->
                             避免的酶切位点:  <?php echo ($wh['gene_avoid_site']); ?>
                              &nbsp;;&nbsp;保留的酶切位点 :  <?php echo ($wh['gene_save_site']); ?> &nbsp;;&nbsp;
                             起始密码子 :
                             <?php if(($wh['gene_seo_result']) == "0"): endif; ?>
                             <?php if(($wh['gene_seo_result']) == "1"): ?>需要，ATG.<?php endif; ?>
                             <?php if(($wh['gene_seo_result']) == "2"): ?>不需要<?php endif; ?>&nbsp;;&nbsp;
                             终止密码子:
                             <?php if(($wh['gene_seo_result_a']) == "0"): endif; ?>
                             <?php if(($wh['gene_seo_result_a']) == "1"): ?>需要，TAG 或者 TAA 或者 TGA.<?php endif; ?>
                             <?php if(($wh['gene_seo_result_a']) == "2"): ?>不需要<?php endif; ?>&nbsp;;&nbsp;
                             指定终止的序列 :  <?php echo ($wh["gene_rel_serial"]); ?>&nbsp;;&nbsp;
                             备注 : <?php echo ($wh['gene_seo_note']); ?>
              ...
              <tr align="center">
                 ...
                 <td align="left">
                         ...
                         是否需要亚克隆：
                        <?php if(($wh["gene_other"]) == "1"): ?>否<?php endif; ?>
                         <?php if(($wh["gene_other"]) == "2"): ?>是<?php endif; ?>&nbsp;;&nbsp;
                          
                       
                       <?php if(($wh["gene_other"]) == "2"): ?>亚克隆载体名称：<?php echo ($wh["gene_clone_ya"]); ?>&nbsp;;&nbsp;
                        克隆位点_5':   <?php echo ($wh["gene_clone_site"]); ?>&nbsp;;&nbsp;
                        克隆位点_3':   <?php echo ($wh["gene_clone_site_a"]); ?>&nbsp;;&nbsp;
                        抗性 : <?php echo ($wh["gene_clone_kx"]); ?>&nbsp;;&nbsp;
                        测序引物 : <?php echo ($wh["gene_clone_cy"]); ?>&nbsp;;&nbsp;
                        载体序列 : <?php echo ($wh["gene_clone_zx"]); ?>&nbsp;;&nbsp;<?php endif; ?>
              ...
              <tr align="center">
                 ...
                 <td align="left">
                         ...
                         <?php if(($wh["gene_zhili_sel"]) == "1"): ?>准备交付: 2-4 μg (免费)<?php endif; ?>
                         <?php if(($wh["gene_zhili_sel"]) == "2"): ?>自定义质粒制备:
                            <?php if(($wh["gene_zhili_content"]) == "0"): ?>0<?php endif; ?>
                            <?php if(($wh["gene_zhili_content"]) == "1"): ?>100 μg<?php endif; ?>
                            <?php if(($wh["gene_zhili_content"]) == "2"): ?>200 μg<?php endif; ?>
                            <?php if(($wh["gene_zhili_content"]) == "3"): ?>300 μg<?php endif; ?>
                            <?php if(($wh["gene_zhili_content"]) == "4"): ?>400 μg<?php endif; ?>
                            <?php if(($wh["gene_zhili_content"]) == "5"): ?>500 μg<?php endif; ?>
                            <?php if(($wh["gene_zhili_content"]) == "6"): ?>1 mg<?php endif; ?>
                           


                             <!-- 模板名称:<?php echo ($wh["gene_zhili_name"]); ?>; -->
                             <br/>
                             质量级别 : <?php if(($wh["gene_zhili_level"]) == "1"): ?>普通转化级<?php endif; ?>
                        <?php if(($wh["gene_zhili_level"]) == "2"): ?>细胞转染级(去内毒素)<?php endif; endif; ?>
...
<script>
  $(function(){
    ...
    $("#liuyan_order").click(function(){
        ...
        // alert("111");
         $.ajax({
           type: "GET",
           url: "/index.php/Home/Gene/liuyan",
           // url:"./liuyan",
  ...
  function go(){
     $.ajax({
           type: "GET",
           url: "/index.php/Home/Gene/liuyan_all",
           // url:"./liuyan",

...
<div id="main">
	<div class="maincon">
		<div class="bread">提交订单 - 步骤 1 / 2：输入样品信息</div>
        <div class="order_con">

		<form method="post" action="<?php echo U('Index/step');?>" id="stepForm">

        <table width="100%" cellspacing="1" cellpadding="1" border="0">
			<tr>
           	  <th class="fs16">创建订单：</th>
                <th>
			...
			<tr>
				...
				<tr>
					<td>创建在线表单：</td>
						<td><input type="text" id="aaaa" name="num" size="4"  style="border:1px solid black;"/> (1 到 94)反应数量 <input type="image" src="/Public/Home/images/form_btn.gif" /> </td>
					</tr>
				</table>
				...
				<tr>
					<td>下载表格</td>
						<td><a href="<?php echo U('Index/test_excel');?>" style="color:red;" title="点击此处下载">测试订单Excel下载</a></td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						<td>上传表格</td>
						<td><input type="file" name="excel" size="2" /> 

	...
	<div class="maincon">
            ...
            <div class="news_con">
               ...
               <!--  <hr/> -->
                ...
                <div class="lianxi_con" style="margin-top:0px;">
                    <div class="bread" style="margin-left:-10px;">引物订单列表相关信息&nbsp;&nbsp;
                    ...
                    <form id="sequencingForm" method="post" action="<?php echo U('Primer/list_more');?>">
        ...
        <!-- <button  style="cursor:pointer;" onclick="javascript:window.location.history.back();">   返回上一步  </button> -->
                                ...
                                <select id="select7" name="select7" class="index-12">
                                  ...
                                  <?php $__FOR_START_2064399834__=1;$__FOR_END_2064399834__=$pages+1;for($pageNum=$__FOR_START_2064399834__;$pageNum < $__FOR_END_2064399834__;$pageNum+=1){ ?><option value="<?php echo ($pageNum); ?>"><?php echo ($pageNum); ?></option><?php } ?>
                                </select>
                                页</td>
                            </tr>

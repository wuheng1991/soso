	...
	<div class="maincon">
        ...
        <div class="rright">
            ...
            <div class="news_con">
               ...
               <!--  <hr/> -->
                <!-- a开始 -->
                <div class="lianxi_con" style="margin-top:0px;">
                    <div class="bread" style="margin-left:-10px;">基因订单列表相关信息&nbsp;&nbsp;
                    ...
                    <form id="sequencingForm" method="post" action="<?php echo U('Gene/list_more');?>">
                    <input type="hidden" name="page" id="page" value="<?php echo ($page); ?>" />
                      ...
                      <table width="100%"  cellspacing="1" cellpadding="1" border="0">
                        <tr align="center">
                            ...
                            <td style="background-color:#008C00; color:white;text-align:center;">订单数</th>
                        ...
                        <?php if(is_array($orderList)): foreach($orderList as $key=>$OL): ?><tr align="center">
                            ...
                            <?php elseif($OL['ordertype'] == 6): ?>       
                                ...
                                <?php echo ($OL["code_yw"]); ?></a></td><?php endif; ?>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" bgcolor="#F9F9F9" class="index-3">
                            <tr>
                                <td width="240" align="center" class="bj-3">&nbsp;</td>
                                <td width="400" align="center" class="bj-3">
        <!-- <button  style="cursor:pointer;" onclick="javascript:window.location.history.back();">   返回上一步  </button> -->
    </td>
                                <td width="200" align="center" class="bj-3">共<?php echo ($pages); ?>页&nbsp;&nbsp;<img id="pre" src="/Public/Consel/images/2_r2.jpg" width="15" height="15" title="上一页">&nbsp;&nbsp;<img id="next" src="/Public/Consel/images/2_r1.jpg" width="15" height="15" 
                                    title="下一页">&nbsp;&nbsp;
                                <select id="select7" name="select7" class="index-12">
                                  <option value="">跳转</option>
                                  <?php $__FOR_START_568800619__=1;$__FOR_END_568800619__=$pages+1;for($pageNum=$__FOR_START_568800619__;$pageNum < $__FOR_END_568800619__;$pageNum+=1){ ?><option value="<?php echo ($pageNum); ?>"><?php echo ($pageNum); ?></option><?php } ?>
                                </select>
                                页</td>
                            </tr>

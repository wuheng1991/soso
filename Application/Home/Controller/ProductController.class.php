...
class ProductController extends Controller {
    public function index(){
      ...
      //     $filePath = $flag_type['excelurl'];
        ...
        // exit;
         for($currentRow=1;$currentRow<=10000;$currentRow++){
            //从哪列开始，A表示第一列
            for($currentColumn='A';$currentColumn<='U';$currentColumn++){
              // if($currentColumn == 'A' || $currentColumn == 'R' || $currentColumn == 'T'){
                //数据坐标

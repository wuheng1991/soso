...
//设置列的宽度
  ...
  // $phpexcel->getActiveSheet()->getColumnDimension('A')->setWidth(2.8);
  // $phpexcel->getActiveSheet()->getColumnDimension('B')->setWidth(10.8);
  // $phpexcel->getActiveSheet()->getColumnDimension('C')->setWidth(17.28);
  // $phpexcel->getActiveSheet()->getColumnDimension('D')->setWidth(39.22);
  // $phpexcel->getActiveSheet()->getColumnDimension('E')->setWidth(4.22);
  // $phpexcel->getActiveSheet()->getColumnDimension('F')->setWidth(8);
  // $phpexcel->getActiveSheet()->getColumnDimension('G')->setWidth(8);
  // $phpexcel->getActiveSheet()->getColumnDimension('H')->setWidth(7.6);
  // $phpexcel->getActiveSheet()->getColumnDimension('i')->setWidth(9.6);
  // $phpexcel->getActiveSheet()->getColumnDimension('j')->setWidth(8.6);
  // $phpexcel->getActiveSheet()->getColumnDimension('K')->setWidth(9.6);
